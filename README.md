...
Modified based on personal needs.
...
Theme config file is `_config.yml` in //theme/yilia/
Refer to [Config Template](https://github.com/litten/BlogBackup) for extra info.
The following is the original config file.
